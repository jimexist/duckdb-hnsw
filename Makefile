...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="hnsw" -DDUCKDB_OOT_EXTENSION_HNSW_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_HNSW_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_HNSW_INCLUDE_PATH="$(PROJ_DIR)src/include"
